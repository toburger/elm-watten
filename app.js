...
/***/ function(module, exports, __webpack_require__) {
	...
	const Elm = __webpack_require__(15)
...
/***/ function(module, exports) {
	...
	Elm.Spiel = Elm.Spiel || {};
	Elm.Spiel.Kortn = Elm.Spiel.Kortn || {};
	Elm.Spiel.Kortn.make = function (_elm) {
	   "use strict";
	   _elm.Spiel = _elm.Spiel || {};
	   _elm.Spiel.Kortn = _elm.Spiel.Kortn || {};
	   if (_elm.Spiel.Kortn.values) return _elm.Spiel.Kortn.values;
	   var _U = Elm.Native.Utils.make(_elm),
	   $Basics = Elm.Basics.make(_elm),
	   $Debug = Elm.Debug.make(_elm),
	   $List = Elm.List.make(_elm),
	   ...
	   $Signal = Elm.Signal.make(_elm);
	   var _op = {};
	   var schlogAlsNummer = function (schlog) {
	      var _p0 = schlog;
	      switch (_p0.ctor)
	      {case "Siebmer": return 7;
	         case "Ochter": return 8;
	         case "Neiner": return 9;
	         case "Zehner": return 10;
	         case "Unter": return 11;
	         case "Ober": return 12;
	         case "Kinig": return 13;
	         default: return 14;}
	   };
	   var compareSchlog = F2(function (schlog1,schlog2) {
	      return A2($Basics.compare,
	      schlogAlsNummer(schlog1),
	      schlogAlsNummer(schlog2));
	   });
	   var Wheli = {ctor: "Wheli"};
	   var Kort = F2(function (a,b) {
	      return {ctor: "Kort",_0: a,_1: b};
	   });
	   var Ass = {ctor: "Ass"};
	   var Kinig = {ctor: "Kinig"};
	   var Ober = {ctor: "Ober"};
	   var Unter = {ctor: "Unter"};
	   var Zehner = {ctor: "Zehner"};
	   var Neiner = {ctor: "Neiner"};
	   var Ochter = {ctor: "Ochter"};
	   var Siebmer = {ctor: "Siebmer"};
	   var Oachl = {ctor: "Oachl"};
	   var Lab = {ctor: "Lab"};
	   var Schell = {ctor: "Schell"};
	   var Herz = {ctor: "Herz"};
	   return _elm.Spiel.Kortn.values = {_op: _op
	                                    ,Herz: Herz
	                                    ,Schell: Schell
	                                    ,Lab: Lab
	                                    ,Oachl: Oachl
	                                    ...
	                                    ,Kort: Kort
	                                    ,Wheli: Wheli
	                                    ,schlogAlsNummer: schlogAlsNummer
	                                    ,compareSchlog: compareSchlog};
	};
	Elm.Spiel = Elm.Spiel || {};
	Elm.Spiel.Spieler = Elm.Spiel.Spieler || {};
	Elm.Spiel.Spieler.make = function (_elm) {
	   "use strict";
	   _elm.Spiel = _elm.Spiel || {};
	   _elm.Spiel.Spieler = _elm.Spiel.Spieler || {};
	   if (_elm.Spiel.Spieler.values) return _elm.Spiel.Spieler.values;
	   var _U = Elm.Native.Utils.make(_elm),
	   $Basics = Elm.Basics.make(_elm),
	   $Debug = Elm.Debug.make(_elm),
	   $List = Elm.List.make(_elm),
	   ...
	   $Result = Elm.Result.make(_elm),
	   $Signal = Elm.Signal.make(_elm),
	   $Spiel$Kortn = Elm.Spiel.Kortn.make(_elm);
	   var _op = {};
	   var Team = F4(function (a,b,c,d) {
	      return {id: a,name: b,punktestond: c,spieler: d};
	   });
	   var Spieler = F3(function (a,b,c) {
	      return {id: a,name: b,hond: c};
	   });
	   return _elm.Spiel.Spieler.values = {_op: _op
	                                      ,Spieler: Spieler
	                                      ,Team: Team};
	};
	Elm.Spiel = Elm.Spiel || {};
	Elm.Spiel.Packtl = Elm.Spiel.Packtl || {};
	Elm.Spiel.Packtl.make = function (_elm) {
	   "use strict";
	   _elm.Spiel = _elm.Spiel || {};
	   _elm.Spiel.Packtl = _elm.Spiel.Packtl || {};
	   if (_elm.Spiel.Packtl.values) return _elm.Spiel.Packtl.values;
	   var _U = Elm.Native.Utils.make(_elm),
	   $Array = Elm.Array.make(_elm),
	   $Basics = Elm.Basics.make(_elm),
	   $Debug = Elm.Debug.make(_elm),
	   ...
	   $Signal = Elm.Signal.make(_elm),
	   $Spiel$Kortn = Elm.Spiel.Kortn.make(_elm),
	   $Spiel$Spieler = Elm.Spiel.Spieler.make(_elm);
	   var _op = {};
	   var gebm = F2(function (teams,packtl) {
	      var packtlRest = A2($List.drop,20,packtl);
	      var _p0 = teams;
	      var team1 = _p0._0;
	      var team2 = _p0._1;
	      var _p1 = team1.spieler;
	      var spieler1 = _p1._0;
	      var spieler3 = _p1._1;
	      var spieler1$ = _U.update(spieler1,
	      {hond: A2($List.take,5,packtl)});
	      var spieler3$ = _U.update(spieler3,
	      {hond: A2($List.take,5,A2($List.drop,10,packtl))});
	      var _p2 = team2.spieler;
	      var spieler2 = _p2._0;
	      var spieler4 = _p2._1;
	      var spieler2$ = _U.update(spieler2,
	      {hond: A2($List.take,5,A2($List.drop,5,packtl))});
	      var spieler4$ = _U.update(spieler4,
	      {hond: A2($List.take,5,A2($List.drop,15,packtl))});
	      var team1$ = _U.update(team1,
	      {spieler: {ctor: "_Tuple2",_0: spieler1$,_1: spieler3$}});
	      var team2$ = _U.update(team2,
	      {spieler: {ctor: "_Tuple2",_0: spieler2$,_1: spieler4$}});
	      return {ctor: "_Tuple2"
	             ,_0: {ctor: "_Tuple2",_0: team1$,_1: team2$}
	             ,_1: packtlRest};
	   });
	   var mischgln = F2(function (seed,packtl) {
	      var seed$ = $Random.initialSeed(seed);
	      return $Array.toList($Basics.fst(A3($Basics.flip,
	      $Random.generate,
	      seed$,
	      $Random$Array.shuffle($Array.fromList(packtl)))));
	   });
	   var packtl = function () {
	      var schleg = _U.list([$Spiel$Kortn.Siebmer
	                           ,$Spiel$Kortn.Ochter
	                           ,$Spiel$Kortn.Neiner
	                           ,$Spiel$Kortn.Zehner
	                           ,$Spiel$Kortn.Unter
	                           ...
	                           ,$Spiel$Kortn.Kinig
	                           ,$Spiel$Kortn.Ass]);
	      var forbm = _U.list([$Spiel$Kortn.Schell
	                          ,$Spiel$Kortn.Oachl
	                          ,$Spiel$Kortn.Lab
	                          ,$Spiel$Kortn.Herz]);
	      return A2($List._op["::"],
	      ...
	      function (forb) {
	         return A2($List.map,
	         function (schlog) {
	            return A2($Spiel$Kortn.Kort,forb,schlog);
	         },
	         schleg);
	      },
	      forbm));
	   }();
	   var kort = F2(function (forb,schlog) {
	      return A2($Spiel$Kortn.Kort,forb,schlog);
	   });
	   return _elm.Spiel.Packtl.values = {_op: _op
	                                     ,kort: kort
	                                     ,packtl: packtl
	                                     ,mischgln: mischgln
	                                     ,gebm: gebm};
	...
	Elm.Main.make = function (_elm) {
	   ...
	   $Signal = Elm.Signal.make(_elm),
	   $Spiel$Kortn = Elm.Spiel.Kortn.make(_elm),
	   $Spiel$Packtl = Elm.Spiel.Packtl.make(_elm),
	   $Spiel$Spieler = Elm.Spiel.Spieler.make(_elm),
	   ...
	   var kortnNome = function (kort) {
	      ...
	      if (_p0.ctor === "Kort") {
	            ...
	            var forb$ = $String.toLower($Basics.toString(_p0._0));
	            ...
	            A2($Basics._op["++"],
	            "/",
	            A2($Basics._op["++"],schlog$,".png")))));
	         } else {
	            return A2($Basics._op["++"],path,"/wheli.png");
	         }
	   };
	   var zugAlsNummer = function (zug) {
	      var _p1 = zug;
	      if (_p1.ctor === "Nothing") {
	            return 0;
	         } else {
	            ...
	            {case "Spieler1": return 1;
	               ...
	               case "Spieler3": return 3;
	               default: return 4;}
	         }
	   };
	   var kortEntfernen = F2(function (kort,_p2) {
	      var _p3 = _p2;
	      var filterSpieler = function (spieler) {
	         return _U.update(spieler,
	         {hond: A2($List.filter,
	         F2(function (x,y) {    return !_U.eq(x,y);})(kort),
	         spieler.hond)});
	      };
	      var filterTeam = function (team) {
	         return _U.update(team,
	         {spieler: {ctor: "_Tuple2"
	                   ,_0: filterSpieler($Basics.fst(team.spieler))
	                   ,_1: filterSpieler($Basics.snd(team.spieler))}});
	      };
	      return {ctor: "_Tuple2"
	             ,_0: filterTeam(_p3._0)
	             ,_1: filterTeam(_p3._1)};
	   });
	   var KortSpieln = F2(function (a,b) {
	      return {ctor: "KortSpieln",_0: a,_1: b};
	   });
	   var viewKort = F3(function (address,spieler,kort) {
	      var attribs = function () {
	         var _p4 = spieler;
	         if (_p4.ctor === "Just") {
	               return _U.list([A2($Html$Events.onClick,
	               address,
	               A2(KortSpieln,_p4._0,kort))]);
	            } else {
	               return _U.list([]);
	            }
	      }();
	      return A2($Html.li,
	      _U.list([$Html$Attributes.$class("inline-block mr1")]),
	      _U.list([A2($Html.img,
	      A2($Basics._op["++"],
	      _U.list([$Html$Attributes.src(kortnNome(kort))
	              ,$Html$Attributes.height(100)
	              ,$Html$Attributes.title($Basics.toString(kort))]),
	      attribs),
	      _U.list([]))]));
	   });
	   var viewSpieler = F3(function (address,zug,spieler) {
	      var ok = _U.eq(zugAlsNummer(zug),spieler.id);
	      return A2($Html.div,
	      A2($Basics._op["++"],
	      _U.list([]),
	      ok ? _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
	                                                    ,_0: "background-color"
	                                                    ,_1: "lightsteelblue"}]))]) : _U.list([])),
	      _U.list([A2($Html.h2,
	              _U.list([$Html$Attributes.$class("h2")]),
	              _U.list([$Html.text(spieler.name)]))
	              ,A2($Html.ul,
	              _U.list([$Html$Attributes.$class("list-reset")]),
	              A2($List.map,
	              A2($Html$Lazy.lazy2,
	              viewKort(address),
	              ok ? $Maybe.Just(spieler) : $Maybe.Nothing),
	              spieler.hond))]));
	   });
	   var viewTeam = F3(function (address,zug,team) {
	      return A2($Html.div,
	      _U.list([$Html$Attributes.$class("sm-col sm-col-4")]),
	      _U.list([A2($Html.h1,
	              _U.list([$Html$Attributes.$class("h1")]),
	              ...
	              _U.list([A3($Html$Lazy.lazy2,
	                      viewSpieler(address),
	                      zug,
	                      $Basics.fst(team.spieler))
	                      ,A3($Html$Lazy.lazy2,
	                      viewSpieler(address),
	                      zug,
	                      $Basics.snd(team.spieler))]))]));
	   });
	   var viewTisch = F3(function (address,zug,tisch) {
	      return A2($Html.div,
	      _U.list([$Html$Attributes.$class("sm-col sm-col-4")]),
	      _U.list([A2($Html.h1,
	              _U.list([$Html$Attributes.$class("h1")]),
	              _U.list([$Html.text("tisch")]))
	              ,A2($Html.ul,
	              _U.list([]),
	              A2($List.map,
	              $Html$Lazy.lazy(A2(viewKort,address,$Maybe.Nothing)),
	              tisch))]));
	   });
	   var viewPacktl = F2(function (address,packtl) {
	      return A2($Html.div,
	      _U.list([]),
	      _U.list([A2($Html.h1,
	              _U.list([$Html$Attributes.$class("h1")]),
	              _U.list([$Html.text("packtl")]))
	              ,A2($Html.ul,
	              _U.list([$Html$Attributes.$class("list-reset")]),
	              A2($List.map,
	              $Html$Lazy.lazy(A2(viewKort,address,$Maybe.Nothing)),
	   ...
	   var Gebm = {ctor: "Gebm"};
	   var Mischgler = function (a) {
	      return {ctor: "Mischgler",_0: a};
	   };
	   var Mischgln = {ctor: "Mischgln"};
	   var view = F2(function (address,_p5) {
	      ...
	      _U.list([A2($Html.button,
	              _U.list([$Html$Attributes.$class("btn")
	                      ,A2($Html$Events.onClick,address,Mischgln)]),
	              _U.list([$Html.text("nui mischgln")]))
	              ,A2($Html.button,
	              _U.list([$Html$Attributes.$class("btn")
	                      ,$Html$Attributes.disabled(!_U.eq($List.length(_p7),33))
	                      ,A2($Html$Events.onClick,address,Gebm)]),
	              _U.list([$Html.text("gebm")]))
	              ,A2($Html.div,
	              ...
	              _U.list([A3($Html$Lazy.lazy2,
	                      ...
	                      _p9,
	                      $Basics.fst(_p8))
	                      ,A3($Html$Lazy.lazy2,viewTeam(address),_p9,$Basics.snd(_p8))
	                      ,A3($Html$Lazy.lazy2,viewTisch(address),_p9,_p6.tisch)]))
	              ,A2($Html$Lazy.lazy,viewPacktl(address),_p7)]));
	   });
	   var Model = F5(function (a,b,c,d,e) {
	      return {teams: a,packtl: b,tisch: c,zug: d,runde: e};
	   });
	   var Runde5 = {ctor: "Runde5"};
	   var Runde4 = {ctor: "Runde4"};
	   var Runde3 = {ctor: "Runde3"};
	   var Runde2 = {ctor: "Runde2"};
	   var Runde1 = {ctor: "Runde1"};
	   var Spieler4 = {ctor: "Spieler4"};
	   var Spieler3 = {ctor: "Spieler3"};
	   var Spieler2 = {ctor: "Spieler2"};
	   var Spieler1 = {ctor: "Spieler1"};
	   var zugWeiter = function (zug) {
	      var _p10 = zug;
	      if (_p10.ctor === "Nothing") {
	            return $Maybe.Just(Spieler1);
	         } else {
	            switch (_p10._0.ctor)
	            {case "Spieler1": return $Maybe.Just(Spieler2);
	               case "Spieler2": return $Maybe.Just(Spieler3);
	               case "Spieler3": return $Maybe.Just(Spieler4);
	               default: return $Maybe.Nothing;}
	         }
	   };
	   var spieler = F2(function (id,nome) {
	      return A3($Spiel$Spieler.Spieler,id,nome,_U.list([]));
	   });
	   var spieler1 = A2(spieler,1,"sepp");
	   var spieler2 = A2(spieler,2,"franz");
	   var spieler3 = A2(spieler,3,"toni");
	   var team1 = {id: 1
	               ,name: "team uans"
	               ,punktestond: 0
	               ,spieler: {ctor: "_Tuple2",_0: spieler1,_1: spieler3}};
	   var spieler4 = A2(spieler,4,"luis");
	   var team2 = {id: 2
	               ,name: "team zwoa"
	               ,punktestond: 0
	               ,spieler: {ctor: "_Tuple2",_0: spieler2,_1: spieler4}};
	   var teams = {ctor: "_Tuple2",_0: team1,_1: team2};
	   var initialModel = {ctor: "_Tuple2"
	                      ,_0: {teams: teams
	                           ,packtl: $Spiel$Packtl.packtl
	                           ,tisch: _U.list([])
	                           ,zug: $Maybe.Nothing
	                           ,runde: $Maybe.Nothing}
	                      ,_1: $Effects.tick(function (_p11) {
	                         return Mischgler($Basics.round(A2(F2(function (x,y) {
	                            return x * y;
	                         }),
	                         1000.0,
	                         _p11)));
	   ...
	   var update = F2(function (action,model) {
	      var _p12 = A2($Debug.log,"action",action);
	      switch (_p12.ctor)
	      {case "Mischgln": return initialModel;
	         case "Mischgler": return {ctor: "_Tuple2"
	                                  ,_0: _U.update(model,
	                                  {packtl: A2($Spiel$Packtl.mischgln,_p12._0,model.packtl)})
	                                  ,_1: $Effects.none};
	         case "Gebm": var _p13 = A2($Spiel$Packtl.gebm,
	           model.teams,
	           model.packtl);
	           var teams = _p13._0;
	           var packtl = _p13._1;
	           return {ctor: "_Tuple2"
	                  ...
	                  {teams: teams
	                  ,packtl: packtl
	                  ,zug: $Maybe.Just(Spieler1)
	                  ,runde: $Maybe.Just(Runde1)})
	                  ,_1: $Effects.none};
	         default: var _p14 = _p12._1;
	           return {ctor: "_Tuple2"
	                  ,_0: _U.update(model,
	                  {teams: A2(kortEntfernen,_p14,model.teams)
	                  ,tisch: A2($List._op["::"],_p14,model.tisch)
	   ...
	   return _elm.Main.values = {_op: _op
	                             ...
	                             ,Mischgler: Mischgler
	                             ,Gebm: Gebm
	                             ,KortSpieln: KortSpieln
	                             ,kortEntfernen: kortEntfernen
	                             ,zugWeiter: zugWeiter
	                             ,zugAlsNummer: zugAlsNummer
	                             ,update: update
	                             ,kortnNome: kortnNome
	                             ,viewKort: viewKort
	                             ,viewSpieler: viewSpieler
	                             ,viewTeam: viewTeam
	                             ,viewTisch: viewTisch
	                             ,viewPacktl: viewPacktl
	                             ,view: view
	                             ,app: app
	                             ,main: main};
	};
